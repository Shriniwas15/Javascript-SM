...
//67 Implement a Simple Graph with Adjacency List and Weights
...
const graphListWeighted = new GraphListWeighted();

graphListWeighted.addEdge("A", "B", 5);
graphListWeighted.addEdge("A", "C", 3);
graphListWeighted.addEdge("B", "D", 2);

console.log(("67   ")+ JSON.stringify(graphListWeighted.getNeighbors("A"))); // [{"node":"B","weight":5},{"node":"C","weight":3}]
console.log(("67   ")+ JSON.stringify(graphListWeighted.getNeighbors("B"))); // [{"node":"A","weight":5},{"node":"D","weight":2}]
console.log(("67   ")+ JSON.stringify(graphListWeighted.getNeighbors("E"))); // [] (no neighbors)

//68 Implement a Simple Graph with Adjacency Matrix and Weights
...
const graphMatrixWeighted = new GraphMatrixWeighted(5);

graphMatrixWeighted.addEdge(0, 1, 5);
graphMatrixWeighted.addEdge(0, 2, 3);
graphMatrixWeighted.addEdge(1, 3, 2);

console.log(("68   ")+ graphMatrixWeighted.getWeight(0, 1)); // 5
console.log(("68   ")+ graphMatrixWeighted.getWeight(0, 3)); // 0 (no edge)

//69 Implement a Simple Graph with Adjacency Set and Weights

class GraphAdjacencySetWeighted{
...
const graphAdjacencySetWeighted = new GraphAdjacencySetWeighted();

graphAdjacencySetWeighted.addEdge("A", "B", 5);
graphAdjacencySetWeighted.addEdge("A", "C", 3);
graphAdjacencySetWeighted.addEdge("B", "D", 2);

console.log(("69   ")+ JSON.stringify(graphAdjacencySetWeighted.getNeighbors("A"))); // [["B",5],["C",3]]
...
//71 Implement a Simple Graph with Edge List and Weights

class GraphEdgeListWeighted2{
...
const graphEdgeListWeighted2 = new GraphEdgeListWeighted2();

graphEdgeListWeighted2.addEdge("A", "B", 5);
graphEdgeListWeighted2.addEdge("A", "C", 3);
graphEdgeListWeighted2.addEdge("B", "D", 2);

console.log(("71   ")+ JSON.stringify(graphEdgeListWeighted2.getEdges())); 
// [{"v1":"A","v2":"B","weight":5},{"v1":"A","v2":"C","weight":3},{"v1":"B","v2":"D","weight":2}].  

  //72 Implement a Simple Graph with Adjacency List and Weights

class GraphListWeighted2{
...
const graphListWeighted2 = new GraphListWeighted2();

graphListWeighted2.addEdge("A", "B", 5);
graphListWeighted2.addEdge("A", "C", 3);
graphListWeighted2.addEdge("B", "D", 2);

console.log(("72   ")+ JSON.stringify(graphListWeighted2.getNeighbors("A"))); // [{"node":"B","weight":5},{"node":"C","weight":3}]
console.log(("72   ")+ JSON.stringify(graphListWeighted2.getNeighbors("B"))); // [{"node":"A","weight":5},{"node":"D","weight":2}]
console.log(("72   ")+ JSON.stringify(graphListWeighted2.getNeighbors("E"))); // [] (no neighbors)

//73 Implement a Simple Graph with Adjacency Matrix and Weights

class GraphMatrixWeighted2{
...
const graphMatrixWeighted2 = new GraphMatrixWeighted2(5);

graphMatrixWeighted2.addEdge(0, 1, 5);
graphMatrixWeighted2.addEdge(0, 2, 3);
graphMatrixWeighted2.addEdge(1, 3, 2);

console.log(("73   ")+ graphMatrixWeighted2.getWeight(0, 1)); // 5
console.log(("73   ")+ graphMatrixWeighted2.getWeight(0, 3)); // 0 (no edge)

//74 Implement a Simple Graph with Adjacency Set and Weights
class GraphSetWeighted2{
...
const graphSetWeighted2 = new GraphSetWeighted2();

graphSetWeighted2.addEdge("A", "B", 5);
graphSetWeighted2.addEdge("A", "C", 3);
graphSetWeighted2.addEdge("B", "D", 2);

console.log(("74   ")+ graphSetWeighted2.getWeight("A", "B")); // 5
console.log(("74   ")+ graphSetWeighted2.getWeight("A", "D")); // 0 (no edge)

//75 Implement a Simple Graph with Adjacency Map and Weights

class GraphMapWeighted2{
...
const graphMapWeighted2 = new GraphMapWeighted2();

graphMapWeighted2.addEdge("A", "B", 5);
graphMapWeighted2.addEdge("A", "C", 3);
graphMapWeighted2.addEdge("B", "D", 2);
...
console.log(("80   ")+ graphMapWeighted3.getWeight("A", "D")); // 0 (no edge) 
  ...
  //81 Implement a Simple Graph with Edge List and Weights

class GraphEdgeListWeighted4{
...
const graphEdgeListWeighted4 = new GraphEdgeListWeighted4();

graphEdgeListWeighted4.addEdge("A", "B", 5);
graphEdgeListWeighted4.addEdge("A", "C", 3);
graphEdgeListWeighted4.addEdge("B", "D", 2);

console.log(("81   ")+ JSON.stringify(graphEdgeListWeighted4.getEdges())); 
// [{"v1":"A","v2":"B","weight":5},{"v1":"A","v2":"C","weight":3},{"v1":"B","v2":"D","weight":2}].      

//82 Implement a Simple Graph with Adjacency List and Weights

class GraphListWeighted4{
...
const graphListWeighted4 = new GraphListWeighted4();

graphListWeighted4.addEdge("A", "B", 5);
graphListWeighted4.addEdge("A", "C", 3);
graphListWeighted4.addEdge("B", "D", 2);

console.log(("82   ")+ JSON.stringify(graphListWeighted4.getNeighbors("A"))); // [{"node":"B","weight":5},{"node":"C","weight":3}]
console.log(("82   ")+ JSON.stringify(graphListWeighted4.getNeighbors("B"))); // [{"node":"A","weight":5},{"node":"D","weight":2}]
console.log(("82   ")+ JSON.stringify(graphListWeighted4.getNeighbors("E"))); // [] (no neighbors)      

//83 Implement a Simple Graph with Adjacency Matrix and Weights

class GraphMatrixWeighted4{
...
const graphMatrixWeighted4 = new GraphMatrixWeighted4(5);

graphMatrixWeighted4.addEdge(0, 1, 5);
graphMatrixWeighted4.addEdge(0, 2, 3);
graphMatrixWeighted4.addEdge(1, 3, 2);
...
//85 Implement a Simple Graph with Adjacency Map and Weights

class GraphMapWeighted4{
...
const graphMapWeighted4 = new GraphMapWeighted4();

graphMapWeighted4.addEdge("A", "B", 5);
graphMapWeighted4.addEdge("A", "C", 3);
graphMapWeighted4.addEdge("B", "D", 2);

console.log(("85   ")+ graphMapWeighted4.getWeight("A", "B")); // 5
console.log(("85   ")+ graphMapWeighted4.getWeight("A", "D")); // 0 (no edge)
